...
export type ChillingNonrevealingDataProvidersFailed = ContractEventLog<{}>;
...
export interface FtsoManager extends BaseContract {
  ...
  methods: {
    ...
    getRewardExpiryOffsetSeconds(): NonPayableTransactionObject<string>;

    getUpdateGovernanceParametersTs(): NonPayableTransactionObject<string>;
    ...
    notInitializedFtsos(_ftso: string): NonPayableTransactionObject<boolean>;
    ...
    setElasticBandWidthPPMFtsos(
      _updateTs: number | string | BN,
      _ftsos: string[],
      _widths: (number | string | BN)[]
    ): NonPayableTransactionObject<void>;
    ...
    setGovernanceParameters(
      ...
      _elasticBandRewardBIPS: number | string | BN,
  ...
  events: {
    ...
    ChillingNonrevealingDataProvidersFailed(
      cb?: Callback<ChillingNonrevealingDataProvidersFailed>
    ): EventEmitter;
    ChillingNonrevealingDataProvidersFailed(
      options?: EventOptions,
      cb?: Callback<ChillingNonrevealingDataProvidersFailed>
