...
async function runProcessCalculateRewards() {
   ...
   await calculatingRewardsService.calculateRewards(rewardEpoch, requiredFtsoPerformanceWei, boostingFactor, votePowerCapBIPS, uptimeVotigPeriodLengthSeconds, rps, batchSize, uptimeVotingThreshold, minForBEBGwei,rewardAmountEpochWei, apiPath);
}
